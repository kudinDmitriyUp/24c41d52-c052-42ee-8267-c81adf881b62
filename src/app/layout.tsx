...
export const metadata: Metadata = {
  title: "FireGuard - Advanced Fire Safety SaaS Platform",
  description: "Intelligent fire detection and safety management system with 99.9% accuracy. Real-time alerts, compliance automation, and seamless integration.",
  keywords: "fire safety, fire detection, SaaS platform, emergency alerts, building safety, compliance management",
  openGraph: {
    title: "FireGuard - Advanced Fire Safety SaaS",
    description: "Protect your buildings with intelligent fire safety technology. Real-time detection, instant alerts, compliance automation.",
    siteName: "FireGuard",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35zM4fOy9cqxgTNTBAZnIPKH5wN/uploaded-1764108339147-6p2gnag9.jpg",
      alt: "FireGuard fire safety monitoring"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "FireGuard - Fire Safety SaaS",
    description: "Advanced fire detection with 99.9% accuracy and instant emergency alerts",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35zM4fOy9cqxgTNTBAZnIPKH5wN/uploaded-1764108339147-6p2gnag9.jpg"]
  },
  robots: {
    index: true,
    follow: true
